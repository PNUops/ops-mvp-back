...
public enum ContestExceptionType implements BaseExceptionType {
    ...
    ADMIN_ONLY_FOR_PAST_CONTEST(HttpStatus.FORBIDDEN, "관리자만 과거 대회의 정보를 수정할 수 없습니다."),
    CANNOT_MOVE_TO_CURRENT_CONTEST(HttpStatus.FORBIDDEN, "현재 진행 중인 대회의 새로운 대회를 생성할 수 없습니다.");
